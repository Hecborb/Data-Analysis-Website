# layout.py — complete template layout utilities
...
class TemplateLayout:
    ...
    def navbar(self):
        return dbc.NavbarSimple(
            children=[
                ...
                dbc.NavItem(dbc.NavLink("Main Menu", href="/main-menu", style={"color": "#FFFFFF", "font-weight": "bold"})),
    ...
    def create_home_page(self):
        return dbc.Container([
            ...
            html.Div(style={
                ...
                "zIndex": -1,
                "opacity": 1,  # adjust 0.0–1.0 to taste
            }),
                html.Div([
                    html.H1([
                        "Welcome to ",
    ...
    def create_main_menu_page(self):
        return dbc.Container([
            ...
            html.P("Upload a dataset and preview it.", className="text-center mb-4", style={"font-size": "18px", "color": "#555"}),
            dbc.Row([
                dbc.Col([
                    dcc.Upload(
                        id="upload-data",
            ...
            dbc.Row([
                ...
                dbc.Col([
                    ...
                    dcc.Dropdown(
                        id="plot-column-y",
                        options=[],
                        multi=True,  # ← enables checkboxes / multi-select
            ...
            dbc.Row([
                dbc.Col([
                    dbc.Checklist(
                        ...
                        value=[],
                        id="ma-toggle",
                        switch=True,  # renders as a toggle switch
                        inline=True,
                    ),
                ], md=4),
                dbc.Col([
    ...
    def create_s_page(self):
        return dbc.Container([
            ...
            ], className="mb-2", style={"width": "80%", "margin-left": "auto", "margin-right": "auto", "text-align": "center"}),
            html.Div([
                html.H3("Key Features", style={"color": "#000000", "font-weight": "bold"}),
                dbc.Row([
                    dbc.Col([
                        dbc.Card([
                            dbc.CardBody([
                                html.H4("Front-end GUI", className="card-title", style={"color": "#000000"}),
                                html.P("A user-friendly interface for interacting with the tool.", className="card-text", style={"color": "#7F8C8D"}),
                            ])
                        ], className="shadow-sm mb-2 h-100")
                    ], width=4, className="d-flex"),
                    dbc.Col([
                        dbc.Card([
                            dbc.CardBody([
                                html.H4("Dash Features", className="card-title", style={"color": "#000000"}),
                                html.P("Interactive visualizations with Plotly Dash.", className="card-text", style={"color": "#7F8C8D"}),
                            ])
                        ], className="shadow-sm mb-2 h-100")
                    ], width=4, className="d-flex"),
                    dbc.Col([
                        dbc.Card([
                            dbc.CardBody([
                                html.H4("Python Development", className="card-title", style={"color": "#000000"}),
                                html.P("Build and deploy Python applications with ease.", className="card-text", style={"color": "#7F8C8D"}),
                            ])
                        ], className="shadow-sm mb-2 h-100")
                    ], width=4, className="d-flex"),
                ])
